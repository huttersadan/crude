...
def linear_classify(total_data,n_clusters,hidden_size,dropout  = 0.1):
    
    X = [[single_data['input'][0],
          single_data['input'][1],
          single_data['input'][2]]
    ...
    model = linear_model_pytorch(3,hidden_size,n_clusters,dropout = dropout).to(device)
