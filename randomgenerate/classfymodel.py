...
def linear_classify(total_data,n_clusters,hidden_size):
    X = [[single_data['input'][0]/(single_data['input'][0]+single_data['input'][1]+single_data['input'][2]),
          single_data['input'][1]/(single_data['input'][0]+single_data['input'][1]+single_data['input'][2]),
          single_data['input'][2]/(single_data['input'][0]+single_data['input'][1]+single_data['input'][2])]
